...
public class MultiplePAGImageViewActivity extends AppCompatActivity {
    ...
    void fireImageView(int id, String path) {
        ...
        ScaleAnimation animScaleOut = new ScaleAnimation(1f, 0.606060f, 1f, 0.606060f, ScaleAnimation.RELATIVE_TO_SELF, 0.5f, ScaleAnimation.RELATIVE_TO_SELF, 0f);
        animScaleOut.setDuration(100);
        animScaleOut.setFillAfter(true);
